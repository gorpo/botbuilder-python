...
class O365ConnectorCardTextInput(O365ConnectorCardInputBase):
    ...
    def __init__(self, type=None, id=None, is_required=None, title=None, value=None, is_multiline=None, max_length=None):
        super(O365ConnectorCardTextInput, self).__init__(type=type, id=id, is_required=is_required, title=title, value=value)
