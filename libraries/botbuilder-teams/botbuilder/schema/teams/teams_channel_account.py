...
class TeamsChannelAccount(ChannelAccount):
    ...
    def __init__(self, id=None, name=None, given_name=None, surname=None, email=None, user_principal_name=None):
        super(TeamsChannelAccount, self).__init__(id=id, name=name)
