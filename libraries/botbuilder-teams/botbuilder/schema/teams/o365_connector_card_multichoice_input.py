...
class O365ConnectorCardMultichoiceInput(O365ConnectorCardInputBase):
    ...
    def __init__(self, type=None, id=None, is_required=None, title=None, value=None, choices=None, style=None, is_multi_select=None):
        super(O365ConnectorCardMultichoiceInput, self).__init__(type=type, id=id, is_required=is_required, title=title, value=value)
