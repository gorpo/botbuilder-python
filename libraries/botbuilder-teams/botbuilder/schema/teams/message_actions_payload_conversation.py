...
class MessageActionsPayloadConversation(Model):
    ...
    :type conversation_identity_type: str or ~teamsapi.models.enum
    ...
    def __init__(self, conversation_identity_type=None, id=None, display_name=None):
        super(MessageActionsPayloadConversation, self).__init__()
