...
class O365ConnectorCardActionCard(O365ConnectorCardActionBase):
    ...
    :type inputs: list[~teamsapi.models.O365ConnectorCardInputBase]
    ...
    :type actions: list[~teamsapi.models.O365ConnectorCardActionBase]
    """
    ...
    def __init__(self, type=None, name=None, id=None, inputs=None, actions=None):
        super(O365ConnectorCardActionCard, self).__init__(type=type, name=name, id=id)
        self.inputs = inputs
