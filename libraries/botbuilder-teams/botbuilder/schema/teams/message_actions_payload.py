...
class MessageActionsPayload(Model):
    ...
    :type message_type: str or ~teamsapi.models.enum
    ...
    :type attachments: list[~teamsapi.models.MessageActionsPayloadAttachment]
    :param mentions: List of entities mentioned in the message.
    :type mentions: list[~teamsapi.models.MessageActionsPayloadMention]
    :param reactions: Reactions for the message.
    :type reactions: list[~teamsapi.models.MessageActionsPayloadReaction]
    """
    ...
    def __init__(self, id=None, reply_to_id=None, message_type=None, created_date_time=None, last_modified_date_time=None, deleted=None, subject=None, summary=None, importance=None, locale=None, from_property=None, body=None, attachment_layout=None, attachments=None, mentions=None, reactions=None):
        super(MessageActionsPayload, self).__init__()
        self.id = id
