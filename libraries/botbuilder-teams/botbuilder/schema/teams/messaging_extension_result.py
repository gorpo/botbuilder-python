...
class MessagingExtensionResult(Model):
    ...
    :type attachment_layout: str or ~teamsapi.models.enum
    ...
    :type attachments: list[~teamsapi.models.MessagingExtensionAttachment]
    :param suggested_actions:
    :type suggested_actions:
     ~teamsapi.models.MessagingExtensionSuggestedAction
    :param text: (Only when type is message) Text
    :type text: str
    :param activity_preview: (Only when type is botMessagePreview) Message
     activity to preview
    :type activity_preview: ~teamsapi.models.Activity
    """
    ...
    def __init__(self, attachment_layout=None, type=None, attachments=None, suggested_actions=None, text=None, activity_preview=None):
        super(MessagingExtensionResult, self).__init__()
