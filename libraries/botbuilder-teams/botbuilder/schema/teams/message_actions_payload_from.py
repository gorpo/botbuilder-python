...
class MessageActionsPayloadFrom(Model):
    ...
    :type user: ~teamsapi.models.MessageActionsPayloadUser
    :param application: Represents details of the app.
    :type application: ~teamsapi.models.MessageActionsPayloadApp
    :param conversation: Represents details of the converesation.
    :type conversation: ~teamsapi.models.MessageActionsPayloadConversation
    """
    ...
    def __init__(self, user=None, application=None, conversation=None):
        super(MessageActionsPayloadFrom, self).__init__()
        self.user = user
