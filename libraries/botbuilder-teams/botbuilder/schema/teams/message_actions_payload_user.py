...
class MessageActionsPayloadUser(Model):
    ...
    :type user_identity_type: str or ~teamsapi.models.enum
    ...
    def __init__(self, user_identity_type=None, id=None, display_name=None):
        super(MessageActionsPayloadUser, self).__init__()
