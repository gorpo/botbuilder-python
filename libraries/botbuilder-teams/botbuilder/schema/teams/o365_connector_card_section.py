...
class O365ConnectorCardSection(Model):
    ...
    def __init__(self, title=None, text=None, activity_title=None, activity_subtitle=None, activity_text=None, activity_image=None, activity_image_type=None, markdown=None, facts=None, images=None, potential_action=None):
        super(O365ConnectorCardSection, self).__init__()
        self.title = title
        self.text = text
